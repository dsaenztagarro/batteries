...
ActiveRecord::Schema.define(version: 20_150_711_165_102) do
  ...
  add_index 'properties', %w(attributable_type attributable_id), name: 'index_properties_on_attributable_type_and_attributable_id', using: :btree
